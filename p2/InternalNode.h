...
public:
  ...
  BTreeNode* put(int value);
  void addtoleft(BTreeNode* child);
  void addtoright(BTreeNode* child);
  InternalNode* split(BTreeNode* child,InternalNode *p,InternalNode *left,InternalNode *right);
